INSERT INTO billing.organizations(org_name, org_inn) VALUES 
	('Физ. лицо', NULL),
...
INSERT INTO billing.services(service_name, service_package, service_tariff) VALUES
	...
	('Только интернет', '{"min": 0, "smhs": 100, "internet": 1000, "max_members": 1}', '{"tariff": 200.0, "extra_min": 1.5, "extra_sms": 1.0, "extra_internet": 5.0}'),
...
INSERT INTO billing.accounts(acc_balance, acc_history, acc_credit, acc_terms) VALUES
	(2557, '{"2024-01-21": 1575, "2024-01-21": -76, "2024-01-21": 958, "2024-01-21": -590, "2024-01-21": 690}', 300, '2024-03-26'),
	(975, '{"2024-01-21": 1648, "2024-01-21": -989, "2024-01-21": 779, "2024-01-21": -653, "2024-01-21": 190}', 100, '2024-06-05'),
	(165, '{"2024-01-21": 1370, "2024-01-21": -679, "2024-01-21": 143, "2024-01-21": -509, "2024-01-21": 741, "2024-01-22": -901}', 400, '2024-07-09'),
	(1483, '{"2024-01-21": 1586, "2024-01-21": -631, "2024-01-21": 528}', 1000, '2024-08-08'),
	(1515, '{"2024-01-21": 1838, "2024-01-21": -323}', 100, '2024-06-21');
	
INSERT INTO billing.clients(client_org, client_name, client_info, acc_id) VALUES
...
INSERT INTO billing.client_service(client_id, service_id, contract_num, contract_begin) VALUES
